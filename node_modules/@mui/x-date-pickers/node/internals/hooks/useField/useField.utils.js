...
exports.splitFormatIntoSections = exports.setSectionValue = exports.getSectionVisibleValue = exports.getSectionValueNumericBoundaries = exports.getMonthsMatchingQuery = exports.getDateSectionNameFromFormat = exports.createDateStrFromSections = exports.cleanTrailingZeroInNumericSectionValue = exports.adjustInvalidDateSectionValue = exports.adjustDateSectionValue = exports.addPositionPropertiesToSections = void 0;
...
const getDateSectionNameFromFormat = format => {
...
exports.getDateSectionNameFromFormat = getDateSectionNameFromFormat;
...
const adjustDateSectionValue = (utils, date, datePartName, keyCode) => {
...
const splitFormatIntoSections = (utils, format, date) => {
  ...
  const locale = utils.locale || _enUS.default;
