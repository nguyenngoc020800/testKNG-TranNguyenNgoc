...
const useField = params => {
  ...
  const {
    ...
    validator
        ...
        otherProps = (0, _objectWithoutPropertiesLoose2.default)(params.props, _excluded);
  ...
  const handleInputClick = (0, _useEventCallback.default)(() => {
  ...
  const handleInputBlur = (0, _useEventCallback.default)(() => updateSelectedSections());
  ...
  const validationError = (0, _useValidation.useValidation)((0, _extends2.default)({}, params.props, {
